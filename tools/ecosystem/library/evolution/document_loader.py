...
"""
Auto-generated wrapper for document_loader
...
class DocumentLoaderTool:
    """Wrapper for document_loader tool."""
    ...
    def __init__(self):
        ...
        self.manifest = {
  "identity": {
    "uuid": "cogplan-tool-2025-08-06-document-loader",
  ...
  "protocol": {
    "type": "native",
    "native_config": {
      "module": "tools.library.document_loader",
      "class": "Document_LoaderTool"
    }
  },
  "interface": {
    "inputs": [
